...
public class DatabaseHelperTest {
    ...
    public void testInsertAppointment() throws SQLException {
        ...
        Appointment test = new Appointment("Test", "0777777777", "TM01TST", "TestCar", "TestModel", 2000, "testPath", testDate, "Test Problem Description", "Test Repairs", "Test Parts", "Test Observations");
    ...
    public void testUpdateAppointment() throws SQLException {
        // 1. Create original
        Date date = new Date();
        Appointment original = new Appointment("John Doe", "0711111111", "TM11TEST", "Audi", "A4", 2010, "", date, "Oil Change", "Reparation", "Parts", "Observations");
    ...
    public void testSearchFunction() throws SQLException {
        ...
        DatabaseHelper.addAppointmentTransaction(new Appointment("Client A", "0711111111", "TM01A", "Audi", "A4", 2010, "", now, "Fix", "Fixed", "Parts", "Obs"));
        DatabaseHelper.addAppointmentTransaction(new Appointment("Client B", "0722222222", "TM02B", "BMW", "X5", 2015, "", now, "Fix", "Fixed", "Parts", "Obs"));
    ...
    public void testAutoUpdateStatuses() throws SQLException {
        ...
        Appointment pastAppointment = new Appointment("Lazy Client", "0700000000", "TM00OLD", "Ford", "Focus", 2005, "", yesterday, "Late", "No repair", "No parts", "No observations");
